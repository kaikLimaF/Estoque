import VectorIndexApi, { CreateIndexOptions } from '@supabase/storage-js/src/lib/vectors/VectorIndexApi';
import VectorDataApi from '@supabase/storage-js/src/lib/vectors/VectorDataApi';
import { Fetch } from '@supabase/storage-js/src/lib/vectors/fetch';
import VectorBucketApi from '@supabase/storage-js/src/lib/vectors/VectorBucketApi';
import { ApiResponse, DeleteVectorsOptions, GetVectorsOptions, ListIndexesOptions, ListVectorsOptions, ListVectorBucketsOptions, ListVectorBucketsResponse, PutVectorsOptions, QueryVectorsOptions, VectorBucket } from '@supabase/storage-js/src/lib/vectors/types';
/**
 *
 * @alpha
 *
...
export declare class VectorBucketScope extends VectorIndexApi {
     ...
     * ```
     */
    listIndexes(options?: Omit<ListIndexesOptions, 'vectorBucketName'>): Promise<ApiResponse<import("@supabase/storage-js/src/lib/vectors/types").ListIndexesResponse>>;
    /**
     *
     * @alpha
     *
    ...
    getIndex(indexName: string): Promise<ApiResponse<{
        index: import("@supabase/storage-js/src/lib/vectors/types").VectorIndex;
    }>>;
    /**
     *
     * @alpha
...
export declare class VectorIndexScope extends VectorDataApi {
     ...
     * ```
     */
    getVectors(options: Omit<GetVectorsOptions, 'vectorBucketName' | 'indexName'>): Promise<ApiResponse<import("@supabase/storage-js/src/lib/vectors/types").GetVectorsResponse>>;
    /**
     *
     * @alpha
     *
     ...
     * ```
     */
    listVectors(options?: Omit<ListVectorsOptions, 'vectorBucketName' | 'indexName'>): Promise<ApiResponse<import("@supabase/storage-js/src/lib/vectors/types").ListVectorsResponse>>;
    /**
     *
     * @alpha
     *
     ...
     * ```
     */
    queryVectors(options: Omit<QueryVectorsOptions, 'vectorBucketName' | 'indexName'>): Promise<ApiResponse<import("@supabase/storage-js/src/lib/vectors/types").QueryVectorsResponse>>;
    /**
     *
     * @alpha
     *
