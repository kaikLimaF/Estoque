import { DEFAULT_HEADERS } from '@supabase/storage-js/src/lib/vectors/constants'
import { isStorageVectorsError } from '@supabase/storage-js/src/lib/vectors/errors'
import { Fetch, post } from '@supabase/storage-js/src/lib/vectors/fetch'
import { resolveFetch } from '@supabase/storage-js/src/lib/vectors/helpers'
import {
  ApiResponse,
  VectorIndex,
  ListIndexesOptions,
