...
import type { Fetch, GenericSchema, SupabaseClientOptions } from '@supabase/supabase-js/src/lib/types';
import { GetRpcFunctionFilterBuilderByArgs } from '@supabase/supabase-js/src/lib/rest/types/common/rpc';
/**
 * Supabase Client.
 *
