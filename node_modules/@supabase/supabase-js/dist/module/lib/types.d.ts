...
import type { GenericSchema, GenericRelationship, GenericTable, GenericUpdatableView, GenericNonUpdatableView, GenericView, GenericFunction } from '@supabase/supabase-js/src/lib/rest/types/common/common';
